...
class BasePage:
    ...
    def go_to_login_page(self): #метод  уже в main page
        link = self.browser.find_element(*BasePageLocators.LOGIN_LINK)
        link.click()

    def should_be_login_link(self): #метод  уже в main page
...
#Упадет, как только увидит искомый элемент. Не появился:тест пройден.
